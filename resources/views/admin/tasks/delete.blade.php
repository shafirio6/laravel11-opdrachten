            ...
            <div class="p-4">
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <label class="block text-sm">
                        ...
                        <input   class="bg-gray-200 block rounded w-full p-2 mt-1
                               focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                                 type="text" name="task" value="{{ $task->task }}" disabled/>
                    </label>
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <input   class="bg-gray-200 block rounded w-full p-2 mt-1
                               focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                                 type="date" name="begindate" value="{{ $task->begindate }}" disabled/>
                    </label>
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <input class="bg-gray-200 block rounded w-full p-2 mt-1
                    focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                               type="date" name="enddate" value="{{ $task->enddate }}" disabled/>
                    </label>
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <select name="activity_id"
                            ...
                            @foreach($activities as $activity)
                                <option value="{{ $activity->id }}" disabled>{{ $activity->name }}</option>
                            @endforeach
                        </select>
                    </label>
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <select name="project_id"
                            ...
                            @foreach($projects as $project)
                                <option value="{{ $project->id }}" disabled>{{ $project->name }}</option>
                            @endforeach
                        </select>
                    </label>
